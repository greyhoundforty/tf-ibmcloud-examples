...
sed -i "s|LOCAL_PUBLIC_PEER_IP|$VRA_PUBLIC_LOCAL_PEER|g" /tmp/dal13create-tunnels.vcli 
sed -i "s|LOCAL_PRIVATE_PEER_IP|$VRA_PRIVATE_LOCAL_PEER|g" /tmp/dal13create-tunnels.vcli 
sed -i "s|PASSWORD|$VRA_SECRET|g" /tmp/dal13create-tunnels.vcli 

/bin/vcli /tmp/dal13create-tunnels.vcli